...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    const daiTokenAddress = "0xC8e8af986b6E18F30FC3e93138DC1A2359EB55CA"; // Replace DAI Address Here
  ...
  openCamera() {
    ...
    var html5QrcodeScanner = new window.Html5QrcodeScanner(
      "reader", { fps: 10, qrbox: 250 });
    window.html5QrcodeScanner = html5QrcodeScanner;
    html5QrcodeScanner.render((mess) => { this.onScanSuccess(mess, html5QrcodeScanner) });
  ...
  onScanSuccess(qrCodeMessage, scanner) {
    ...
    scanner.html5Qrcode.stop().then(ignore => {
      console.log('stopped');
    }).catch(err => {
      console.log('err');
    });
      ...
      <div>
        ...
        <div className="container-fluid mt-5" id="wrapper">
          <div className="row fl-left">
            <main role="main" className="col-lg-12 d-flex text-center">
              ...
              >
                ...
                <button className="btn btn-info my-qr" onClick={() => { this.openQR() }}>My QR</button>
                ...
                >
                  ...
                  <div className="form-group mr-sm-2 address">
                    <input
                      ...
                      required
                    />
                    <i className="fa fa-camera" onClick={() => { this.openCamera() }}></i>
                  </div>
          ...
          <div className="fl-left" id="my-qr-page">
            <button className="btn btn-info my-qr back" onClick={() => { this.closeQR() }}>Back</button>
